...
* @param Features
*/
public Product(String ID, String Name, String Category, String SubCategory, Pricing Pricing, List<Object> Features, byte[] Image, Specifications Specifications, Integer itemsInStock, Seller Seller, List<Object> citiesForDelivery) {
this.ID = ID;
this.Name = Name;
